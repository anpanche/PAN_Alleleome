...
log_filename= os.path.join(log_directory, f"pan_alleleome_{current_time.strftime('%Y-%m-%d_%H:%M:%S')}.log")
...
def main():
    ...
    try:
        parser=argparse.ArgumentParser(description="PAN_Alleleome")
        parser.add_argument("--path1", help="Enter the path where your pangene directories are saved")
        parser.add_argument("--path2", help="Enter the path of your alleleome directory")
        ...
        if args.path1 and args.path2:
            ...
            QCQA_4.process_genes(args.path1,args.path2)
            ...
            args.path1='./PAN_Alleleome/sample_data/Oenococcus_oeni/pangenome_alignments/'
            args.path2='./PAN_Alleleome/sample_data/Oenococcus_oeni/alleleome/'
            QCQA_1.process_nucleotide_sequences(args.path1,args.path2)
            QCQA_2.analyze_gene_lengths(args.path1,args.path2)
            QCQA_3.process_sequences(args.path1,args.path2)
            QCQA_4.process_genes(args.path1,args.path2)
